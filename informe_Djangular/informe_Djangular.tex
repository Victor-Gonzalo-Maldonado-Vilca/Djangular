...
%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=1\textwidth, keepaspectratio]{img/admin.png}}
    \caption{Admin Django}
  \end{figure}
  \begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=1\textwidth, keepaspectratio]{img/adminAddMovie.png}}
    \caption{Agregando un objeto Movie desde el Admin de Django}
  \end{figure}
  \begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=1\textwidth, keepaspectratio]{img/adminMovies.png}}
    \caption{Visualización de los objetos Movie Creados}
  \end{figure}
  \begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=1\textwidth, keepaspectratio]{img/ApiRoot.png}}
    \caption{Api Root}
  \end{figure}
  \begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=1\textwidth, keepaspectratio]{img/ApiMovieList.png}}
    \caption{Api Movie List}
  \end{figure}
  \subsubsection{Angular}
  \begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=1\textwidth, keepaspectratio]{img/consola.png}}
    \caption{Consola -- Obtener datos de la API}
  \end{figure}
  \begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=1\textwidth, keepaspectratio]{img/ejecucionAngular.png}}
